...
// import { addEvent, updateEvent } from "@/lib/actions/events_actions";
// import { useEffect, useState } from "react";

// const EventsUpdateFormModel = ({ eventData }) => {
...
//     try {
//       const response = await updateEvent(eventData._id, eventData); // Call updateEvent with the formData
//       if (response.success) {
//         window.location.reload();
//         // Optionally, you can provide a success message or close the form
...
//       <button onClick={handleUpdate} type="submit" className={styles.createBtn}>
//         Update
//       </button>
//     </form>
//   );
